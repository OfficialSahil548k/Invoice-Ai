...
// This function will fetch images from server side
...
const BusinessProfile = () => {
  ...
  //fetch profile if saved previously
  useEffect(() => {
    let mounted = true;
  ...
  return (
    <div className={businessProfileStyles.pageContainer}>
      <div className={businessProfileStyles.headerContainer}>
        <h1 className={businessProfileStyles.headerTitle}>BusinessProfile</h1>
